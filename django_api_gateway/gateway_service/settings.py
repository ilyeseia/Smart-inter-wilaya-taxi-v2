"""
Django API Gateway Configuration
Central API Gateway for Smart Inter-Wilaya Taxi Platform microservices
"""
...
# Security
SECRET_KEY = os.environ.get('SECRET_KEY', 'gateway-secret-key-change-in-production')
...
# Database (Gateway doesn't need its own database)
DATABASES = {
    'default': {
